...
def make_model(model, defo_image_size, image_size, num_classes=100):
    if model=='vgg16':
        return vgg16(defo_image_size, image_size, num_classes)
    elif model=='vgg19':
        return vgg19(defo_image_size, image_size, num_classes)
    # elif model=='resnet18':
...
def vgg16(defo_image_size, image_size, num_classes=100, **kwargs):
    return _vgg([2, 2, 3, 3, 3], defo_image_size, image_size, num_classes, **kwargs)

def vgg19(defo_image_size, image_size, num_classes=100, **kwargs):
    return _vgg([2, 2, 4, 4, 4], defo_image_size, image_size, num_classes, **kwargs)
